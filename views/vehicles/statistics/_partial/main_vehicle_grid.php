        ...
        [
            ...
            'buttons' => [
                'calendar' => function ($url, $model) {
                    return
                        Html::label('Kalendár','work_days[main_vehicle]['.$model['id'].']',['class'=> 'btn btn-secondary m-btn m-btn--custom m-btn--label-primary m-btn--bolder'])

                        .Html::input('text','work_days[main_vehicle]['.$model['id'].']',$model['specified_work_dates'],['class' => 'work-days-input','id' => 'work_days[main_vehicle]['.$model['id'].']','style'=> 'border:none;width:0']);
                }
            ],
